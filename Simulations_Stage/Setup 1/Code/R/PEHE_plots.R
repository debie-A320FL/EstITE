...
generate_joy_plot <- function(N = 0, num_ACTG = 80, num_GP =80, x_scale = 0.5){
  ...
  joy_train <-
    ...
    ggtitle(paste0("Model error Distribution (N= ", N, ")")) +
  ...
  # Save joy plots
  file_path_fig_train <- paste0("./Figures/ACTG_Joy_Train_Nsize_",N,".pdf")
  file_path_fig_test <- paste0("./Figures/ACTG_Joy_Test_Nsize_",N,".pdf")
...
generate_joy_plot(N = 1000, x_scale = 3)
